    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="border p-1">
          ...
          <div v-if="state.grade <=90, state.grade >=80">
            <p>The grade is 'B'.</p>
          </div>
          <!-- v-else-if comparing grade and 70 -->
          <div v-if="state.grade <80, state.grade >=70">
            <p>The grade is 'C'.</p>
          </div>
          <!-- v-else-if comparing grade and 60 -->
          <div v-if="state.grade <70, state.grade >=60">
            <p>The grade is 'D'.</p>
          </div>
          <!-- v-else to display if all the others fail -->
          <div v-if="state.grade < 60, state.grade >= 50">
            <p>The grade is 'F'.</p>
          </div>
        </div>
        <div class="border p-1">
